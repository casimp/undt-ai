...
class RegressionInception:

    def __init__(self, output_directory, input_shape, nb_classes=1, verbose=False, build=True, batch_size=64,
    ...
    def _inception_module(self, input_tensor, stride=1, activation='linear'):
        ...
        for k in kernel_size_s:
            conv_list.append(keras.layers.Conv1D(filters=self.nb_filters, kernel_size=k,
...
#         y_pred = self.predict(x_val, y_val, return_df_metrics=False)
...
#         return df_metrics
    ...
    def predict(self, x_test, y_test, return_df_metrics=False):
        ...
        model = self.model.load_weights(model_path)
